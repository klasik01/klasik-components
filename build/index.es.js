...
var PrimaryButtonStyle = Ye.button(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  background: ", ";\n  color: ", ";\n  border: 2px solid ", ";\n\n  &&:hover {\n    color: ", ";\n    background: ", ";\n    border: 2px solid  ", ";\n  }\n"], ["\n  background: ", ";\n  color: ", ";\n  border: 2px solid ", ";\n\n  &&:hover {\n    color: ", ";\n    background: ", ";\n    border: 2px solid  ", ";\n  }\n"])), function (props) { return props.inverse ? props.color1 : props.color2; }, function (props) { return props.inverse ? props.color2 : props.color1; }, function (props) { return props.inverse ? props.color2 : props.color1; }, function (props) { return props.inverse ? props.color1 : props.color2; }, function (props) { return props.inverse ? props.color2 : props.color1; }, function (props) { return props.inverse ? props.color1 : props.color2; });
var PrimaryButton = function (props) {
    var label = props.label, className = props.className, _a = props.inverse, inverse = _a === void 0 ? false : _a, color1 = props.color1, color2 = props.color2, onClick = props.onClick;
    return (react.createElement(PrimaryButtonStyle, { onClick: onClick, color1: color1, color2: color2, inverse: inverse, className: "btn rounded-0 " + className }, label));
};
